...
function WelcomeScene(setScene) {
  ...
  function overTheWindow(envet) { // hover 
    if (!added) {
      scene.add(bin);
      added = true;
      setTimeout(() => {
  ...
  function initObjects() {
    ...
    var texture = new THREE.TextureLoader().load('static/imgs/welcome_page/background.png');
    var materialBackground = new THREE.MeshBasicMaterial({ map: texture, transparent: true });
    ...
    var textureBin = new THREE.TextureLoader().load('static/imgs/welcome_page/bin.png');
    var materialBin = new THREE.MeshBasicMaterial({ map: textureBin, transparent: true });
    ...
    var textureDareToEnter = new THREE.TextureLoader().load('static/imgs/welcome_page/DareToEnter.png');
    var materialDareToEnter = new THREE.MeshBasicMaterial({ map: textureDareToEnter, transparent: true });
